      ...
      <div className="centered px-20 mt-24 mb-96">
        <div className="grid grid-cols-2 px-10 pt-10">
          ...
          rounded-xl hover:bg- hover:shadow-2xl transition duration-300"
              >
                <h3 className="ml-2 mt-2">Create Lootbox</h3>
              </button>
            </div>
          </div>
          ...
          <AnimationOnScroll animateIn="animate__fadeInUp">
            <div className="text-white grid grid-cols-3">
              <div className="col-span-2 text-left">
                ...
                <h2 className="italic">Buy the ticket and win valuable NFT</h2>
                <h2 className="mb-4 italic">or Create lootbox of your own NFT</h2>
      ...
      <section className="bg-black py-36">
        <div className="centered">
          <AnimationOnScroll animateIn="animate__fadeInLeft">
            ...
            <div className="text-white grid grid-cols-2 gap-20 mt-10">
