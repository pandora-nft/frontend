...
export const Header = () => {
  const createNavLink = (label: string) => {
    return <div className="pt-5 pr-5">{label}</div>;
  };
  return (
    <>
      <nav className="p-5 flex flex-row items-center justify-between border-b border-gray-200">
        <div className="flex flex-row items-center justify-center">
          <img className="w-8 h-8" src={'box.png'} alt="icon" />
          <div className="text-3xl pt-[24px] pl-2">Pandora</div>
        </div>
